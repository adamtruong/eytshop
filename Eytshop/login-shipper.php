<?php
  ...
  if (isset($_POST["username"]) && isset($_POST["password"])) {
    ...
    foreach ($data["shipper"] as $line) {
      if (($_POST["username"] == $line["username"]) && (password_verify($_POST["password"], $line["password"]))) {
        session_unset();
        $check = TRUE;
        $_SESSION["logged_in"] = "true";
        $_SESSION["user_type"] = "shipper";
        $_SESSION["shipper_id"] = $line["id"];
        $_SESSION["username"] = $_POST["username"];
        $_SESSION["assigned_hub"] = $line["assigned_distribution_hub"];
        break;
      }
    }
  }

  if (isset($_SESSION["logged_in"]) && $_SESSION["logged_in"] === "true" && isset($_SESSION["user_type"]) && $_SESSION["user_type"] === "shipper") {
      ...
      <section class="clean-block clean-form dark" style="background: #332c54">
        <div class="container">
          ...
          >
            ...
            >
              <strong>login for shipper</strong>
            </h1>
            <div class="mb-3">
            ...
            >
              Login</button
            ><a class="link-dark" href="signup-shipper.php"
              ><p
                class="text-center"
                style="font-weight: bold; text-decoration: underline"
              >
                Create your Eytshop shipper account
              </p></a>
          </form>
